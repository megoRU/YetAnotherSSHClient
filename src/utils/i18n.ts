...
export const translations = {
    ru: {
        ...
        sftp: {
            ...
            rememberForFileType: 'Запомнить для файлов данного типа',
            openWithRememberQuestion: 'Открывать файлы {extension} через {app}?',
            goto: 'Перейти',
    ...
    en: {
        ...
        sftp: {
            ...
            open: 'Open',
            openWith: 'Open with...',
            rememberForFileType: 'Remember for files of this type',
            openWithRememberQuestion: 'Open {extension} files with {app}?',
            goto: 'Go to',
            copyPath: 'Copy path',
