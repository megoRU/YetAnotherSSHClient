...
export const translations = {
    ru: {
        ...
        settings: {
            ...
            scrollSensitivityDesc: 'Единая скорость прокрутки для терминала и полноэкранных приложений, например nano (1 — медленнее, 10 — быстрее)',
    ...
    en: {
        ...
        settings: {
            ...
            scrollSensitivityDesc: 'Unified scroll speed for terminal and fullscreen apps like nano (1 is slower, 10 is faster)',
