...
export const translations = {
    ru: {
        ...
        sftp: {
            ...
            folder: 'Папка',
            link: 'Ссылка',
            fileUpdateTitle: 'Обновление файлов',
            fileUpdateBatchConfirm: 'Следующие файлы были изменены. Выберите те, которые хотите обновить на сервере:',
    ...
    en: {
        ...
        sftp: {
            ...
            fileUpdateBatchConfirm: 'The following files have been modified. Select the ones you want to upload to the server:',
