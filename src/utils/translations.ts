...
export const translations = {
    ru: {
        ...
        sftp: {
            ...
            fileUpdateQueue: 'Следующие файлы были изменены. Выберите те, которые хотите загрузить на сервер:',
    ...
    en: {
        ...
        sftp: {
            ...
            fileUpdateQueue: 'The following files have been changed. Select which ones you want to upload to the server:',
